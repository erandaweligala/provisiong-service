...
@Data
public class TemplateMessageUpdateRequest {

    /**
     * If childTemplateId is null  -> new child template (CREATE)
     * If childTemplateId is not null -> existing child template (UPDATE)
     */
